...
// 	Defines methods to insert and delete nodes in a binary tree, traverse through a binary trees in multiple ways, find the leaves of a tree,
...
//deletes a node in the binary tree and updates the tree after the deletion
